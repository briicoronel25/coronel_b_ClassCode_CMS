	...
	try {
		...
		$mail->Body    = "<html>
						...
						<body>
							...
							<h3> Url to Login </h3>
							<br>".
							"<a href='"."http://".$_SERVER['HTTP_HOST']."/multimedia_research/admin/login.php"."'>". //$_SERVER ENVIRONMENT VARIABLE IS USED TO EXTRACT BASE URL
							$_SERVER['HTTP_HOST']."/multimedia_research/admin/login.php"."<a/>
						</body>
						</html>
		";
